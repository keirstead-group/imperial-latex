\documentclass[a4paper, vc]{projectreport}

\logo{Isambard_Kingdom_Brunel_signature}
\definecolor{projcolor}{RGB}{200,65,153}
\renewcommand{\projecttitlefont}{\color{projcolor}\sffamily\bfseries}
