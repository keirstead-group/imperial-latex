...
\setdept{Department of Aeronautics}
\setaddress{South Kensington Campus, London, SW7 2AZ, UK}
\settelephone{+44 (0)20 7594 5048}
\setfax{+44 (0)20 7584 8120}
\setemail{l.foulkes@imperial.ac.uk}
% http:// not required here
\setweb{www.imperial.ac.uk/aeronautics}
\settitle{Dr}
\author{Letty Foulkes}
\setpostnoms{BA, MS, PhD, CPhys, MInstP}
\setjobtitle{Computer Resources Manager}
...
\setsignature{Isambard_Kingdom_Brunel_signature.png}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
